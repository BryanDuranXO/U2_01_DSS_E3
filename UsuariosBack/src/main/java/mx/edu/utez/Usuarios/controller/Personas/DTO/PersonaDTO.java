...
public class PersonaDTO {
    ...
    public PersonaBean toEntity() {
        if (rolBean == null)
                return new PersonaBean(id,nombre,paterno,materno,correo,telefono,username,estatus,password);
            return new PersonaBean(nombre, paterno, materno, correo, telefono, username,estatus, password, rolBean);
